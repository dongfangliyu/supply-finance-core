...
public class SignHelper {
	...
	public static void initProject() {
		System.out.println("111111111112222222222222");
		ProjectConfig proCfg = new ProjectConfig();
		System.out.println("11333333333333333");
		// 项目ID(应用ID)
		...
		System.out.println("11444444444444444444444");
		// 协议类型，默认https
		httpConCfg.setHttpType(HttpType.HTTPS);
		System.out.println("1155555555555555555");
		// 请求失败重试次数，默认5次
		httpConCfg.setRetry(5);
		System.out.println("11666666666666666666");
		// 代理服务IP地址
		...
		System.out.println("117777777777777777777777");
	 ...
	 * SignType.Single);
	 */
	public static FileDigestSignResult platformSignByStreamm(String srcPdfFile, Integer x, Integer y) {
		// 设置文件流签署的PDF文档信息
		...
		PosBean posBean = setXYPosBean("1",x,y);
	...
	public static FileDigestSignResult userOrganizeSignByStream(byte[] pdfFileStream, String accountId,
                                                                String sealData, String page, Integer x, Integer y) {
