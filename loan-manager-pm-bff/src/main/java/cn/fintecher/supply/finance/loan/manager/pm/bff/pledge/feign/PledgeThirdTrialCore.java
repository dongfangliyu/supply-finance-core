...
public interface PledgeThirdTrialCore {

	
    @Headers("Accept2: application/json")
    @ResponseBody
    @RequestMapping(value = "/pledge/thirdTrial/receiveTask", method = RequestMethod.GET)
    public Message receiveTask(@RequestParam("userName") String userName);
	
    @Headers("Accept2: application/json")
    @ResponseBody
    @RequestMapping(value = "/pledge/thirdTrial/searchPledgeList", method = RequestMethod.POST)
    public Message searchPledgeList(@RequestBody PledgeStockTrialFrom pledgeStockTrialFrom);
	
    @Headers("Accept2: application/json")
    @ResponseBody
    @RequestMapping(value = "/pledge/thirdTrial/searchDetail", method = RequestMethod.GET)
    public Message searchDetail(@RequestParam("id")Long id,@RequestParam("userName") String userName);
	
    @Headers("Accept2: application/json")
    @ResponseBody
    @RequestMapping(value = "/pledge/thirdTrial/submitContnet", method = RequestMethod.POST)
