package cn.fintecher.supply.finance.loan.manager.pm.bff.configuration;
...
import cn.fintecher.supply.finance.loan.manager.pm.bff.sys.service.impl.CustomizeResourceRoleService;
...
//
        ...
        http
                ...
                //.and()
                /*.requestMatchers().antMatchers("/user", "/me", "/account","/testRole","/testFunction","/testRoleAndFunction","/swagger-ui.html","/swagger-resources",
                     "/v2/api-docs","/swagger-resources/**","/verifycode/*","/toLogin","/sysUser/test")*/
