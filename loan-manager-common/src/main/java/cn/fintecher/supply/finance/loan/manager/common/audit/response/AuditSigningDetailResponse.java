...
/**
 * @author wuxiaoxing
 * @time 2018/7/19 13:32
 */
@Data
public class AuditSigningDetailResponse implements Serializable {
    ...
    @ApiModelProperty(value = "实际经营省 ")
    private String enterOperatingProvinceName;

    @ApiModelProperty(value = "实际经营市 ")
    private String enterOperatingCityName;

    @ApiModelProperty(value = "实际经营区 ")
    private String enterOperatingCountyName;
    ...
    @ApiModelProperty(value = "实际经营省 ")
    private String suppOperatingProvinceName;

    @ApiModelProperty(value = "实际经营市 ")
    private String suppOperatingCityName;

    @ApiModelProperty(value = "实际经营区 ")
    private String suppOperatingCountyName;
    ...
    @ApiModelProperty(value = "是否担保 0：拒绝 1：同意")
    ...
    private List<AuditFileEntity> auditFileEntities;
}
