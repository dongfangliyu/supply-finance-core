...
public class DateUtil {
	 ...
	 * 返回传入参数当天的第一秒
	 * 把传入时间改为00：00：00
	 * 例如入参 2018-01-01 12：12：12
	 * 则返回2018-01-01 00：00：00
	 * @throws ParseException 
	 */
	public static String TransformatStartTime(String startTime) throws ParseException {
		return TransformatStartTime(formatDate(startTime,STYLE_2));
	}
	public static String TransformatStartTime(Date date) {
		date.setHours(0);
		date.setMinutes(0);
		date.setSeconds(0);
		return new SimpleDateFormat(STYLE_1).format(date);		
	}
	 ...
	 * 把传入时间改为23：59：59
	 * 例如入参 2018-01-01 12：12：12
	 * 则返回2018-01-01 23：59：59
	 * @throws ParseException 
	 */
	public static String TransformatEndTime(String startTime) throws ParseException {
		return TransformatEndTime(formatDate(startTime,STYLE_2));
	}
	public static String TransformatEndTime(Date date) {
		date.setHours(23);
		date.setMinutes(59);
		date.setSeconds(59);
		return new SimpleDateFormat(STYLE_1).format(date);		
	...
	public static int diffDays(String startDate, String endDate)throws ParseException {
		...
		return diffDays(sdf.parse(startDate),sdf.parse(endDate));
	}
	...
	public static void main(String[] args) {
		try {
			getBetweenDays("2012-10-01", "2017-11-01");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
